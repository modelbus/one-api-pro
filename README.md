...
<img src="docs/logo.png" alt="one-api-pro" width="120" />

# One Api Pro

**An enterprise-grade AI API Gateway, built with Go + Vue 3 — a deep refactor and extension of [one-api](https://github.com/songquanpeng/one-api) by [JustSong](https://github.com/songquanpeng), with a brand-new admin console and a decentralized cluster mode.**

[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Language](https://img.shields.io/badge/language-Go-00ADD8.svg?logo=go&logoColor=white)](https://go.dev/)
[![Framework](https://img.shields.io/badge/framework-Gin-008080.svg?logo=go&logoColor=white)](https://gin-gonic.com/)
[![Frontend](https://img.shields.io/badge/frontend-Vue%203-42B883.svg?logo=vue.js&logoColor=white)](https://vuejs.org/)
[![UI](https://img.shields.io/badge/ui-Arco%20Design-165DFF.svg)](https://arco.design/vue)
[![Build](https://img.shields.io/badge/build-Vite-646CFF.svg?logo=vite&logoColor=white)](https://vitejs.dev/)
[![Database](https://img.shields.io/badge/database-MySQL%20%7C%20PostgreSQL%20%7C%20SQLite-4479A1.svg?logo=mysql&logoColor=white)](https://gorm.io/)
[![Cluster](https://img.shields.io/badge/cluster-decentralized-FF6B6B.svg)](https://github.com/Leon-PanPan/one-api-pro)
...
- [📌 About One Api Pro](#-about-one-api-pro)
...
**One Api Pro** is an **enterprise-grade AI API Gateway** written in Go. It is a deep refactor and extension of the upstream [one-api](https://github.com/songquanpeng/one-api) project (originally by [JustSong](https://github.com/songquanpeng)). Because one-api stopped receiving updates in 2024, One Api Pro continues that lineage with an architecture-level rewrite, a brand-new Vue 3 admin console, and a set of production-grade capabilities aimed at team-scale and cross-region deployments.

At its core, One Api Pro unifies **30+ LLM providers** (OpenAI / Anthropic / Gemini / DeepSeek / Qwen / Wenxin / iFlytek / Zhipu / …) behind a single OpenAI-compatible interface, so existing tools that already speak the OpenAI protocol work without modification.

What sets One Api Pro apart:

- 🧱 **Adaptor self-registration** — adding a new provider means creating a single package and registering it; the framework stays untouched.
- 🔐 **Refined multi-level permissions** — Guest / User / Admin / Root, with the upstream API authorization loophole fixed.
- 📦 **Subscription & plan system** — Token- or request-based billing, period-based rate limits, per-model controls.
- 🌐 **Decentralized active-active cluster** — each node runs its own MySQL + Redis, kept in sync through application-level events. No shared database required; perfect for global low-latency access.
- 🖥️ **Vue 3 + Arco Design admin console** — visual dashboards, per-token access control, sub-net IP restrictions, auditing logs and more.
...
If you find this project useful, please drop us a ⭐!

<a href="https://www.star-history.com/?repos=Leon-PanPan%2Fone-api-pro&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=Leon-PanPan/one-api-pro&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=Leon-PanPan/one-api-pro&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=Leon-PanPan/one-api-pro&type=date&legend=top-left" />
 </picture>
</a>
...
One Api Pro stands on the shoulders of giants:

- [Gin](https://github.com/gin-gonic/gin) — HTTP web framework
- [GORM](https://gorm.io) — ORM
- [Vue 3](https://vuejs.org/) — frontend framework
- [Vite](https://vitejs.dev/) — build tool
- [Arco Design Vue](https://arco.design/vue) — UI library
- [Pinia](https://pinia.vuejs.org/) — state management
- [ECharts](https://echarts.apache.org) — data visualization
- [one-api](https://github.com/songquanpeng/one-api) — the original project by [JustSong](https://github.com/songquanpeng)
